#' @file genre_ui.R
#' @title UI Module for Genre Panel
#'
#' Defines the user interface for the "by Genre" tab of the Chinook 
#' Music Retail Analytics Dashboard. Includes KPI summary cards, a Plotly 
#' bar plot visualization, a scrollable data table, and a themed download 
#' button.
#'
...
#'
#' @seealso \code{\link{genre_server}}, \code{\link[bslib]{layout_column_wrap}}, 
#' \code{\link[shiny]{NS}}

#' Genre Module UI
#'
#' Creates the themed and responsive UI layout for the "by Genre" tab, 
...
genre_ui <- function(id) {
  ...
  div(
    ...
    shiny::tagList(
      ...
      # Interactive by Genre Visualization (Plot)
      plotly::plotlyOutput(ns("genre_plot")),
      ...
      bslib::card(
        ...
        bslib::card_body(DT::dataTableOutput(ns("genre_table"))),
        div(
