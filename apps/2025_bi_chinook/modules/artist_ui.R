...
#'
#' Defines the user interface for the "by Artist" tab of the Chinook 
...
#'
#' @seealso \code{\link{artist_server}}, 
#' \code{\link[bslib]{layout_column_wrap}}, \code{\link[shiny]{NS}}

#' Genre Module UI
#'
#' Creates the themed and responsive UI layout for the "by Artist" tab, 
...
artist_ui <- function(id) {
  ...
  div(
    ...
    shiny::tagList(
      ...
      plotly::plotlyOutput(ns("artist_plot")),
      ...
      bslib::card(
        ...
        bslib::card_body(DT::dataTableOutput(ns("artist_table"))),
        div(
