...
description: "Exploratory business intelligence report using SQL, R, and Python to uncover revenue trends, customer patterns, and strategic insights from the Chinook dataset. Serves as a foundation for KPI-focused dashboards."
author: "Morrigan M."
...
categories: [
  "SQL", "R", "Python", "DuckDB",
  "Dashboard", "Data Analysis", "Business Intelligence", 
  "Exploratory Analysis", "Retail Analytics", 
  "Chinook", "Short", "Portfolio Project"
  ]
...
r_pkgs: ["DBI", "duckdb", "dplyr", "ggplot2", "plotly", "tidyr", "forcats", "countrycode"]
py_pkgs: ["duckdb", "plotly", "pandas", "numpy"]
...
_A recruiter-facing deep dive into SQL-powered exploration, insight generation, and dashboard planning._

This report is part of the **Chinook BI Report: SQL-Driven Insights for a Digital Music Store** portfolio project.  
📁 [Return to project overview](../posts/2025_bi_chinook.html)

This exploratory report forms the analytical backbone of a broader business intelligence project built around the Chinook music store dataset. Designed with real-world decision-making in mind, it walks through key metrics and trends using SQL-driven queries and visual storytelling—establishing the insights later showcased in interactive dashboards.

The goal: simulate how an analyst might approach stakeholder questions with a structured but compact dataset—bridging data modeling, retention analysis, and business-focused visuals.

This report focuses on:

-   Identifying strategic opportunities through data exploration
-   Extracting key performance indicators via SQL (joins, windows, temp tables)
-   Using R and Python for clear, time-based visualizations and storytelling
-   Building a foundation for scalable, interactive dashboards

Visualizations include time-series trends, choropleths, cohort retention heatmaps, and annotated performance insights—all framed in a narrative that reflects executive-level priorities.

# Technology Stack {#tech-stack}

The following tools were used to merge, analyze, and present the data in this document:
...
The database schema was examined through [existing documentation](https://github.com/lerocha/chinook-database) and query-based exploration. A schema diagram was created with [dbdiagram](https://dbdiagram.io/home).
...
## Exploratory Visualizations {#q2-vis}
...
While overall genre revenue remains stable across years, genre-specific performance varies widely depending on how its measured:
...
# Question 3: How many customers are repeat buyers? {#q3}
...
```{sql}
#| label: sql-q3-purchase-interval
#| connection: con_chinook
#| filename: SQL
...
## Exploratory Visualizations {#q3-vis}
...
### Retention Decay Plot {#q3-vis-retention-decay}
...
```{r}
#| label: r-q4-vis-retention-decay
#| warning: FALSE
...
```{python}
#| label: py-q4-vis-retention-decay
#| fig-show: hold
# Retention Decay Plot
# Add a column for formatted hover text
...
### Retention Across Cohorts: Heatmap {#q3-vis-retention-heatmap}
...
```{r}
#| label: r-q4-vis-retention-heatmap
...
```{python}
#| label: py-q4-vis-retention-heatmap
# Cohort Retention Heatmap
...
## Summary of Exploratory Findings {#q3-summary}
